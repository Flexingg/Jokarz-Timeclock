...
[![Release](https://img.shields.io/badge/Release-v2.0.0-purple.svg)](https://github.com/Flexingg/Jokarz-Timeclock/releases/tag/v2.0.0)
...
**Jokarz Timeclock** is a 100% **Native Android Application** built with **Kotlin, Jetpack Compose, and Material You (Material 3)** for **Randall Engineering**. It features precision salary banking calculations, strict overtime cliff triggers, weekend overtime tracking, dynamic system wallpaper theming, animated action controls, procedural audio/haptics, Tasker integration, and full offline local persistence.
...
📥 **[Download Jokarz-Timeclock.apk (v2.0.0 - Native Jetpack Compose)](https://github.com/Flexingg/Jokarz-Timeclock/releases/latest/download/Jokarz-Timeclock.apk)**
